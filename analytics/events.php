							...
							<div class="col-md-6">
								...
								<div class="panel panel-default"  id="panel_2" style="min-height: 480;">
									<div class="panel-heading" >
										...
										<strong id="panel_2_data">Clients Details for the Event</strong>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="panel panel-default" id="panel_3">
									<div class="panel-heading">
											...
											<strong  id="panel_3_data">Events Attended By Clients who Attended Event  </strong>
										<div class="btn-group pull-right">
							...
							<div class="col-md-6">
								...
								<div class="panel panel-default"  id="panel_4">
									<div class="panel-heading">
										<strong id="panel_4_data">Attendance Distribution For Clients who Attended </strong>
										<div class="btn-group pull-right">
...
*/
		...
		{				
			...
			$('#clientSummary-table-id').DataTable( 
			{
					...
					"columnDefs": [ { className: "dt-body-left", "targets": [ 0 ] }, { className: "text_Align_DataTables", "targets": [ 1] }, { className: "text_Align_DataTables", "targets": [ 2 ] }, { className: "text_Align_DataTables", "targets": [ 3 ] },
										{ className: "text_Align_DataTables", "targets": [ 4 ] }, { className: "text_Align_DataTables", "targets": [ 5 ] }, { className: "text_Align_DataTables", "targets": [ 6 ] }
								  ],					
					"pagingType": "full",
					"bDestroy": true,
					"pageLength": 5,
...
*/
		...
		onEventClick = function ()
		{
			...
			$("#panel_2_data").append("<strong> Client Details for the Event " + name + "</strong> ");
			$("#panel_3_data").append("<strong>" + "Events Attended By Clients who Attended Event " + name + "</strong>");
			$("#panel_4_data").append("<strong>" + "Attendance Distribution For Clients who Attended " + name + "</strong>");
		...
		defaultClientTable = function ()
		{
			...
			$("#panel_2_data").append("<strong>" + evData.event_names[default_evnt] + "</strong>");
			$("#panel_3_data").append("<strong>" + evData.event_names[default_evnt] + "</strong>");
			$("#panel_4_data").append("<strong>" +  evData.event_names[default_evnt] + "</strong>");
		...
		function processTable()
		{
			...
			$('#event-summary-table-id').ready(function() {
				...
				$('#event-summary-table-id').dataTable( {
					...
					"responsive":true,
					"aLengthMenu": [5,10],
					"columnDefs": [ { className: "dt-body-left", "targets": [ 0 ] }, { className: "dt-body-left", "targets": [ 1] }, { className: "text_Align_DataTables", "targets": [ 2 ] }, { className: "text_Align_DataTables", "targets": [ 3 ] }, { className: "text_Align_DataTables", "targets": [ 4 ] }, { className: "text_Align_DataTables", "targets": [ 5 ] }, { className: "text_Align_DataTables", "targets": [ 6 ] }
						]
		...
		//	var color = d3.scale.category20();
			...
			svg.append("svg:g")
				  ...
				  .text("Attendance to Invite Percentage");
